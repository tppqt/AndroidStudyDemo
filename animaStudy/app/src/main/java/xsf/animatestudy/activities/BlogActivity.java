...
public class BlogActivity extends BaseActvity {
       ...
       /* if (v == btnMenu) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnMenu:
                ...
                break;
            case R.id.btnItem1:
                Toast.makeText(BlogActivity.this, "点击了Item1", Toast.LENGTH_SHORT).show();
                break;
            case R.id.btnItem2:
                Toast.makeText(BlogActivity.this, "点击了Item2", Toast.LENGTH_SHORT).show();
                break;
            case R.id.btnItem3:
                Toast.makeText(BlogActivity.this, "点击了Item3", Toast.LENGTH_SHORT).show();
                break;
            case R.id.btnItem4:
                Toast.makeText(BlogActivity.this, "点击了Item4", Toast.LENGTH_SHORT).show();
                break;
            case R.id.btnItem5:
                Toast.makeText(BlogActivity.this, "点击了Item5", Toast.LENGTH_SHORT).show();
                break;
        }
